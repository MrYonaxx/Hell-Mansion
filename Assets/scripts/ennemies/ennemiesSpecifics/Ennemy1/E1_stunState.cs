...
public class E1_stunState : StunState
{
    ...
    public E1_stunState(Entity entity, FSM stateMachine, string animBoolName, D_StunState stateData,Ennemy1 ennemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.ennemy = ennemy;
    }
