...
public class E4_idleState : IdleState
{
    ...
    public E4_idleState(Entity entity, FSM stateMachine, string animBoolName, D_idleState stateData,Ennemy4 ennemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.ennemy = ennemy;
    }
